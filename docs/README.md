# StudyPal Documentation

Use this folder for requirements, database design notes, diagrams, reports, test plans, and user documentation.
...
- `project-status-next-steps.md`: implementation status and next steps.
