  ...
  <div class="workspace-main">
    ...
    <main class="workspace-content"><div class="content-inner">
      ...
      <section class="two-grid">
        ...
        <div class="warm-card state-success fade-in-d4"><span class="badge">SUCCESS</span><h2 style="margin-top:14px">MainTask published</h2><p class="muted">Student progress records are ready.</p><a class="action-btn action-btn-primary" href="${pageContext.request.contextPath}/main-tasks.jsp?role=LECTURER">Back to Task List</a></div>
      </section>
    </div></main>
  </div>
</div>
