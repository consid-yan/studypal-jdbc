        ...
        <div class="student-content grid grid-cols-3 gap-6">
          ...
          <div class="student-primary col-span-2 space-y-6">
            ...
            <div class="warm-card p-6 fade-in-d3">
              ...
              <div class="flex items-end justify-between gap-3 h-[120px]">
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 50%;">
                    <div class="absolute bottom-0 w-full bg-primary rounded-t bar-grow" style="--target-height: 100%; animation: bar-grow 1s ease-out 0.6s both;"></div>
                  </div>
                  <span class="text-xs text-textMuted mt-2">Mon</span>
                  <span class="text-xs text-textDark font-medium">2.5h</span>
                </div>
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 60%;">
                    <div class="absolute bottom-0 w-full bg-primary rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 0.7s both; --target-height: 100%;"></div>
                  </div>
                  <span class="text-xs text-textMuted mt-2">Tue</span>
                  <span class="text-xs text-textDark font-medium">3.0h</span>
                </div>
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 30%;">
                    <div class="absolute bottom-0 w-full bg-accent rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 0.8s both; --target-height: 100%;"></div>
                  </div>
                  <span class="text-xs text-textMuted mt-2">Wed</span>
                  <span class="text-xs text-textDark font-medium">1.5h</span>
                </div>
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 80%;">
                    <div class="absolute bottom-0 w-full bg-primary rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 0.9s both; --target-height: 100%;"></div>
                  </div>
                  <span class="text-xs text-textMuted mt-2">Thu</span>
                  <span class="text-xs text-textDark font-medium">4.0h</span>
                </div>
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 40%;">
                    <div class="absolute bottom-0 w-full bg-accent rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 1.0s both; --target-height: 100%;"></div>
                  </div>
                  <span class="text-xs text-textMuted mt-2">Fri</span>
                  <span class="text-xs text-textDark font-medium">2.0h</span>
                </div>
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 70%;">
                    <div class="absolute bottom-0 w-full bg-primary rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 1.1s both; --target-height: 100%;"></div>
                  </div>
                ...
                <div class="flex flex-col items-center flex-1">
                  <div class="w-full bg-primary/20 rounded-t relative overflow-hidden" style="height: 40%;">
                    <div class="absolute bottom-0 w-full bg-accent rounded-t" style="height: 0%; animation: bar-grow 1s ease-out 1.2s both; --target-height: 100%;"></div>
                  </div>
