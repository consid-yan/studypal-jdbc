...
<div class="workspace-shell">
  <aside class="workspace-sidebar">
    ...
    <nav class="workspace-nav">
      ...
      <a class="sidebar-link active" href="${pageContext.request.contextPath}/main-tasks?role=LECTURER"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 4h10M3 8h10M3 12h6"/><circle cx="13" cy="12" r="1.5"/></svg>MainTasks</a>
    ...
    <main class="workspace-content"><div class="content-inner">
      <section class="panel-grid">
        <div class="warm-card fade-in">
          <h2>Create Task</h2>
          <form class="form-stack" data-validate="time-range">
            <div class="form-grid"><div><label>Title</label><input required value="StudyPal Database Project"></div><div><label>Course</label><select required><option>DB2026 - Database Systems</option><option>SE2026 - Software Engineering</option></select></div></div>
            <div class="form-grid"><div><label>Deadline</label><input type="datetime-local" required></div><div><label>Importance</label><select><option>MEDIUM</option><option selected>HIGH</option><option>VERY_HIGH</option></select></div></div>
            <div><label>Description</label><textarea>Complete the course assignment and submit all required materials.</textarea></div>
            <div class="row-between"><button class="action-btn action-btn-primary" type="submit" data-confirm="After publishing, MainTask is not editable or removable by default. Continue?">Publish MainTask</button><a class="action-btn action-btn-secondary" href="${pageContext.request.contextPath}/lecturer-task-detail.jsp?role=LECTURER&id=1">Preview Progress</a></div>
          </form>
        </div>
      ...
      <section class="warm-card fade-in-d2" style="margin-top:24px">
        ...
        <div class="table-like">
          <div class="soft-card table-row"><div><p class="strong-title">StudyPal Database Project</p><p class="muted">Database Systems</p></div><span class="muted">2026-06-01</span><span class="badge accent">VERY_HIGH</span><span class="muted">Published</span><a class="action-btn action-btn-secondary" href="${pageContext.request.contextPath}/lecturer-task-detail.jsp?role=LECTURER&id=1">View</a></div>
          <div class="soft-card table-row"><div><p class="strong-title">SQL View Analysis</p><p class="muted">Database Systems</p></div><span class="muted">2026-06-08</span><span class="badge">HIGH</span><span class="muted">Published</span><a class="action-btn action-btn-secondary" href="${pageContext.request.contextPath}/lecturer-task-detail.jsp?role=LECTURER&id=1">View</a></div>
        </div>
      </section>
    </div></main>
  </div>
